  ...
  const Dashboard = () => {
      ...
      datasets: [
        {
          // labels: ['Male', 'Female', 'Transgender'],
          data: [50, 50, 0,],
          backgroundColor: ['CornflowerBlue', 'LightCoral','Khaki'],
          borderColor: 'white',
          borderWidth: 1,
        },
      ],
      ...
      datasets: [
        {
          label: 'Cases Status',
          data: [300, 10, 0, 300],
          backgroundColor: ['CornflowerBlue','LightCoral', 'Purple', 'Khaki'],
          borderColor: ['CornflowerBlue','LightCoral', 'Purple', 'Khaki'],
          borderWidth: 1,
        },
      ],
    });
      ...
      datasets: [
        {
          ...
          data: [0, 60, 40, 0, 0],
          backgroundColor: ['LightCoral', 'CornflowerBlue','Khaki', 'Purple', 'Brown'],
          borderColor: 'white',
          borderWidth: 1,
        },
      ],
    ...
    const [casesWithCourtOrdersChartData, setCasesWithCoourtOrdersChartData] = useState({
      labels: ['Supervision', 'Custody and Replacement', 'Interim', 'Seek and Fund'],
      datasets: [
        {
          label: 'Cases With Court OrdersData',
          data: [0, 0, 100, 0, 0],
          backgroundColor: ['LightCoral', 'CornflowerBlue','Khaki', 'Purple'],
          borderColor: 'white',
          borderWidth: 1,
        },
      ],
      ...
      datasets: [
        {
          label: 'Doughnut Data',
          data: [10, 20, 30, 40, 50],
          backgroundColor: ['LightCoral', 'CornflowerBlue', 'Purple', 'Khaki', 'MediumSeaGreen'],
          borderColor: 'white',
          borderWidth: 1,
        },
      ],
      ...
      datasets: [
        {
          label: 'Pie Data',
          data: [8, 80, 12],
          backgroundColor: ['LightCoral', 'CornflowerBlue','Khaki'],
          borderColor: 'white',
          borderWidth: 1,
        },
      ],
        ...
        <PageContent>
          ...
          <Grid container spacing={3}>
            <Grid item xl={12} md={12} xs={12} style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <PercentageTile label="Exploitation" percentage={90} count={5} color="Khaki" />
